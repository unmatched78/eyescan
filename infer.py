...
# # ... [Keep the TRANSLATIONS and disease_info dictionaries same as before] ...
...
#         # Find last convolutional layer in base model
#         last_conv_layer = None
#         for layer in base_model.layers[::-1]:  # Reverse search
#             if isinstance(layer, tf.keras.layers.Conv2D):
#                 last_conv_layer = layer
#                 break
        
#         if not last_conv_layer:
#             raise ValueError("No convolutional layer found in EfficientNet base")
...
#     # ... [Rest of PDF content remains same] ...
...
#                         cv2.cvtColor(np.array(image.resize(IMG_SIZE)), cv2.COLOR_RGB2BGR), 0.6,
#                         heatmap, 0.4, 0
#                     )
#                 except Exception as e:
